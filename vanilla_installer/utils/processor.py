...
class Processor:
    ...
    def gen_install_script(log_path, pre_run, post_run, finals):
        ...
        # manifest_remove = "/cdrom/casper_pika/filesystem.manifest-remove"
        ...
        arguments = [
            ...
            "distinst",
            "-s",
            "'/cdrom/casper_pika/filesystem.squashfs'",
            "-r",
            f"'{manifest_remove}'",
            "-h",
            "'vanilla'",
            ...
            for key, value in final.items():
                if key == "users":
                    ...
                    if "auto" in value:
                        ...
                        arguments += [
                            "-n",
                            f"'{device_block}:primary:start:512M:fat32:mount=/boot/efi:flags=esp'",
                        ]
                        arguments += [
                            "-n",
                        ...
                        arguments += [
                            "-n",
                            f"'{device_block}:primary:2048M:end:btrfs:mount=/'",
                        ]
                        ...
                        for partition, values in value.items():
                            ...
                            if values["mp"] == "/boot/efi":
                                ...
                                arguments += [
                                    "-u",
                                    "'{}:{}:{}:mount=/boot:flags=bls_boot'".format(
                                        device_block, partition_number, values["fs"]
                                    ),
                                ]
                            elif values["mp"] == "swap":
